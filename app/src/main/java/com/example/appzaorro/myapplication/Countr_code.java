...
/**
 * Created by vijay on 7/11/16.
 */

public class Countr_code  extends BaseAdapter {
    ...
    public Countr_code( Context cxt )
    {
        super();
    ...
    public View getView(int index, View recycleView, ViewGroup viewGroup) {
     TextView view;
        ...
        String country= m_Countries[index];
        String mobile = m_Codes[index];
        String combine = "+" +"(" +mobile + ") "+country;

        view.setText(combine);
