...
public class Login_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Loginstatus = Customerdetail.getString("LOGINSTATUS","");
        Log.e("loginstatus",Loginstatus);
        userid = Customerdetail.getString("USERID","");
        ...
        userDetail = getSharedPreferences("USERDETAIL", Context.MODE_PRIVATE);
        editor1 =userDetail.edit();
        ...
        if (sharedPreferences.getString("Logged", "").equals("Logged in")) {
