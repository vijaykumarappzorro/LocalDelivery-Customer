...
public class HomePage_Activity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    Intent intent;
    ImageView pinimage,crossimage;
    CardView cardView;
    ArrayList<String>driver_name,latititude,longititude,profilepic;
    RelativeLayout location_layout,destinationlayout,picklayout;
    String strAdd = "", strDestAdd="",searchlocationurl="https://maps.googleapis.com/maps/api/place/details/json?placeid=";
    Toolbar toolbar;
    String place_id="";
    String carStatus="",user_id,SearchStatus,deststatus="required";
    ...
    Activity activity;
    TextView setAddress,txtdestinationaddress;
    float currentsZoomlevel =17f;
    SupportMapFragment mapFragment;
    ImageView sourcesearch_img,destsearch_img;
    ImageView sourceview,destview;
    ViewDialog alert;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        destinationlayout =(RelativeLayout)findViewById(R.id.destlayout);
        picklayout =(RelativeLayout)findViewById(R.id.picklayout);
        txtdestinationaddress= (TextView)findViewById(R.id.txtdestaddress);
        crossimage =(ImageView)findViewById(R.id.imgecross);

        sourcesearch_img =(ImageView)findViewById(R.id.imgsearch);
        destsearch_img=(ImageView)findViewById(R.id.destinsearch);
        sourceview =(ImageView) findViewById(R.id.sourceview);
        destview =(ImageView) findViewById(R.id.destview);
        ...
        user_id = Ldshareadprefernce.readString(activity,"USERID");
        userfirstname =Ldshareadprefernce.readString(activity,"FULLNAME");
        userEmailid =Ldshareadprefernce.readString(activity,"EMAILID");
        userimage = Ldshareadprefernce.readString(activity,"PROFILEPIC");
        usermobile =Ldshareadprefernce.readString(activity,"MOBILENUMBER");
      ...
      picklayout.setOnClickListener(new View.OnClickListener() {
        ...
        txtdestinationaddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(HomePage_Activity.this, Search_Activity.class);
                intent.putExtra("SEARCHSTATUS","PICK");
                intent.putExtra("filledtext",filled_addressed);
        ...
        location_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (deststatus.equals("required")){
                    ...
                    destinationlayout.startAnimation(slide_up);
...
*/
        ...
        switch (event.getKey()) {
            ...
            case "FAILED":
                new SweetAlertDialog(this, SweetAlertDialog.ERROR_TYPE)
                        ...
                        txtdestinationaddress.setText("");
                        txtdestinationaddress.setHint("Destination Required");*/
                        sourcesearch_img.setVisibility(View.GONE);
                       destsearch_img.setVisibility(View.GONE);
    ...
    protected void onResume() {
        ...
        if (place_id!="") {
            ...
            txtdestinationaddress.setVisibility(View.GONE);
            txtdestinationaddress.setText("");
            txtdestinationaddress.setHint("Destination Required");
 ...
 private void Seraclocation( String placeId){
        ...
        try {
         ...
         //   LatLng cur_Latlng=new LatLng(latilong,longititude); // giving your marker to zoom to your location area.
            if (Config.SearchStatus.equals("PICK")){
                ...
                Config.destinationAddress=getDestinationAddress(latilong,longititude);
            ...
            else if (Config.SearchStatus.equals("DROP")) {
  ...
  public void initNavigationDrawer() {
    ...
    private void initCamera(Location location) {
        ...
        Log.e("InitCamera fuction","Are called");
 ...
 // getting the full address from Latitude and logitude, THIS fuction is used to get the siurce address of the user
 private String getCompleteAddressString(double LATITUDE, double LONGITUDE) {
  ...
  // this fuction get the Destination address of the user
    private String getDestinationAddress(double LATITUDE, double LONGITUDE) {
        ...
        try {
            ...
            if (addresses != null) {
                ...
                txtdestinationaddress.setText(strDestAdd);
